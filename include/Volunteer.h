...
class Volunteer {
    public:
        ...
        void clear(); //clears completed order
        ...
        virtual string getDetails() const=0; //gets details for baseAction printCustomerStatus function.
        virtual const int map() const=0; //maps if a volunteer is a driver or a collector
